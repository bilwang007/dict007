...
export default function NotebookPage() {
  ...
  }, [entries, fetchEntries, isLoading])
                ...
                {selectedIds.size === 0 ? (
                  <>
                    <p className="text-sm text-gray-600 mb-4">
                      Select entries using checkboxes, then click &ldquo;Batch Tag&rdquo; again to tag them.
                    </p>
                    <button
                    ...
                    >
                      Got it, I&rsquo;ll select entries first
                    </button>
                  </>
                ) : (
                  <>
